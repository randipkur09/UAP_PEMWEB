        ...
        <div class="col-md-9 col-lg-10">
            <div class="content-wrapper p-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2 class="fw-bold text-primary">Edit Pengguna</h2>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body">
                                <form action="../../pages/pengguna/update.php" method="POST">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" id="role" name="role" required>
                                                    <option value="staff" <?php echo $pengguna['role'] == 'staff' ? 'selected' : ''; ?>>Staff</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" id="status" name="status" required>
                                                    ...
                                                    <option value="nonaktif" <?php echo $pengguna['status'] == 'nonaktif' ? 'selected' : ''; ?>>Non-Aktif</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        if (password.value !== '' && password.value !== konfirmasi.value) {
            e.preventDefault();
