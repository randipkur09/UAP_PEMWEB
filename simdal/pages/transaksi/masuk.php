...
// Ambil data sendal aktif
$stmt = $pdo->query("SELECT * FROM sendal WHERE status = 'aktif' ORDER BY nama_sendal ASC");
        ...
        <div class="col-md-9 col-lg-10">
            <div class="content-wrapper p-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2 class="fw-bold text-success">Transaksi Barang Masuk</h2>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body">
                                <form action="../../actions/transaksi/simpan_masuk.php" method="POST">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="id_sendal" name="id_sendal" required>
                                            ...
                                            <option value="<?php echo $item['id_sendal']; ?>" data-harga="<?php echo $item['harga_beli']; ?>">
                                                <?php echo $item['kode_sendal'] . ' - ' . $item['nama_sendal'] . ' (' . $item['ukuran'] . ', ' . $item['warna'] . ')'; ?>
                                            </option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Auto fill harga saat sendal dipilih
